{ pkgs, ... }:
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-a8dde4ed-4ce5-4c05-84f1-44c700d06a42" = [ ];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."a8dde4ed-4ce5-4c05-84f1-44c700d06a42" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "a8dde4ed-4ce5-4c05-84f1-44c700d06a42";
      "kcminputrc"."Libinput.1133.45088.MX Vertical Mouse"."PointerAcceleration" = "-0.600";
      "kcminputrc"."Libinput.2321.21128.PNP0C50:0b 0911:5288 Mouse"."PointerAcceleration" = 0.000;
      "kcminputrc"."Libinput.2321.21128.PNP0C50:0b 0911:5288 Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput.2321.21128.PNP0C50:0b 0911:5288 Touchpad"."TapToClick" = true;
      ...
      "kdeglobals"."General"."AccentColor" = "242,121,155";
      ...
      "kdeglobals"."WM"."activeBackground" = "14,22,33";
      "kdeglobals"."WM"."activeBlend" = "216,216,216";
      "kdeglobals"."WM"."activeForeground" = "216,216,216";
      "kdeglobals"."WM"."inactiveBackground" = "14,22,33";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{c4b11eef-d822-417f-8799-7c3d45e473ef}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{b17f8bf9-97d7-48f7-b788-1492ddd69a89}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{392ddc7f-af04-4752-a83f-d08cab4c1487}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{d03a11cd-1704-4b35-80e2-397c2b7ebaf7}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{0377c4a3-fb42-4b13-be35-aabe399e8581}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{ae1a22b5-63fe-4722-8809-96078b81d83c}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{bc404497-809b-4aab-b888-e3597d6d0db4}";
      ...
      "kwinrc"."Desktops"."Id_1" = "69af3f4f-1683-4d27-8b6d-b4ee46157958";
      "kwinrc"."Desktops"."Id_2" = "cc9b024c-def3-4f6a-aef1-34aaef5ce845";
      "kwinrc"."Desktops"."Id_3" = "bc6d206b-56a3-4e2b-b6cf-2c38036c4c71";
      ...
      "kwinrc"."Tiling.097774e5-5d97-5d7b-a580-b3044cf09b2d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.24661458333333333},{\"width\":0.24661458333333333},{\"width\":0.5067708333333334}]}";
      "kwinrc"."Tiling.1d44e23e-1339-5c18-aca4-2c5030c200dc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."1"."decocolor" = "BreezeBlackPure";
      "kwinrulesrc"."1"."decocolorrule" = 2;
      "kwinrulesrc"."1"."opacityactive" = 80;
      "kwinrulesrc"."1"."opacityactiverule" = 2;
      "kwinrulesrc"."1"."wmclass" = "wezterm";
      "kwinrulesrc"."1"."wmclassmatch" = 2;
      "kwinrulesrc"."6b079d3a-c72e-48b4-afb1-8d9445c4363b"."Description" = "Application settings for org.wezfurlong.wezterm";
      "kwinrulesrc"."6b079d3a-c72e-48b4-afb1-8d9445c4363b"."opacityactive" = 80;
      "kwinrulesrc"."6b079d3a-c72e-48b4-afb1-8d9445c4363b"."opacityactiverule" = 2;
      "kwinrulesrc"."6b079d3a-c72e-48b4-afb1-8d9445c4363b"."wmclass" = "wezterm";
      "kwinrulesrc"."6b079d3a-c72e-48b4-afb1-8d9445c4363b"."wmclassmatch" = 2;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmanotifyrc"."Notifications"."PopupPosition" = "TopCenter";
      "plasmarc"."Theme"."name" = "UtterlyLouie";
